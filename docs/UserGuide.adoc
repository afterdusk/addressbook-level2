...
== Listing all persons lexicographically sorted by name : `sort`

Shows a list of all persons, along with their non-private details, sorted by their name lexicographically. + 
Format: `sort`
